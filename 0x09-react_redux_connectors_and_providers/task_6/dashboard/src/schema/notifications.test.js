...
test('getAllNotificationsByUser returns correct notifications for user', () => {
  jest.mock('../../dist/notifications.json', () => ([
    {
    ...
    {
      "guid": "4d8e40be-1c78-4de0-afc9-fcc147afd4d3",
      "isRead": false,
      "type": "default",
      "value": "Non diam phasellus vestibulum lorem sed risus ultricies.",
      "userId": "5debd764a7c57c7839d722e8"
    }
  ]));
