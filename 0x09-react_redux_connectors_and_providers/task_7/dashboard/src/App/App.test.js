...
describe('mapStateToProps', () => {
  // Mock Redux store
  // const store = createStore(rootReducer); // Create your store with the rootReducer
  ...
  it('should map state to props correctly when user is not defined', () => {
    ...
    expect(mapStateToProps(stateWithNoUser)).toEqual(expectedProps);
  });
});